    ...
    <div className="hotelContainer">
        <div className="hotelWrapper">
          <button className="bookNow">Reserve or Book Now</button>
            ...
            <span className="hotelDistance">Excelent location 500 m from Framgate </span>
            <span className="hotelPriceHighLight">Book a stay over 113$ at this property and get a free airport service</span>
            <div className="hotelImages">
              {
                photos.map(photo=>(
                  <div className="hotelImgWrapper">
                        <img src={photo.src} className="hotelImg" alt="hotelRoom"/>
                  </div>
                ))
              }
            </div>
            <div className="hotelDetails">
                ...
                <div className="hotelDetailsPrice">
                  ...
                  <span>
                    Located in the heart of dhanmondi, this property has an excelent location store of 9.8
                  </span>
                  <h2>
                    <b>$888</b>(9 nights)
                  </h2>
