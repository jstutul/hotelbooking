...
const SearchItem = ({item}) => {
  const img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSYsq0keW82D9Nb6uSvic9jfekRq8c3d3Lv7LeW2K0k5tQ6oGMrF-nFNdGh_6Jt2HbEmo&usqp=CAU"
  return (
    <div className="searchItem">
      <img
        src={item.photos[0]?item.photos[0]:img }
        alt="siImage"
      />
      ...
      <div className="siDetails">
        {item.ratting && <div className="siRatting">
          <span>Ecelent</span>
